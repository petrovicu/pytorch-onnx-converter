...
# “Real-Time Single Image and Video Super-Resolution Using an Efficient Sub-Pixel Convolutional Neural Network” by
...
# and outputs the upscaled Y component in super resolution.
